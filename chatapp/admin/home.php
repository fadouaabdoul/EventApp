...
<div id="wrapper">
    ...
    <div id="banner">
      <div class="container">
        <div class="title">
          ...
          <span class="byline"><p>what make your events so special is the human. put relationships and interactions with people all arround the world. take the first step by join the chat room.</p></span> </div>
        <ul class="actions">
          <li><a href="../chat/index.php" class="button">Chat</a></li>
        </ul>
      </div>
  </div>
  </div>
  <div id="page" class="container">
      ...
      <div id="featured">
			<div class="container">
				<div class="title">
					<h2>If you were a just a user please change your loin type from here </h2>
